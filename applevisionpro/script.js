...
const frameCount = 199;//change the framecount according to the number of images
...
scrollTrigger: {
scrub: 0.15,
trigger: `canvas`,//change the trigger accporing to your id
...
var ratio = Math.min(hRatio, vRatio);//change min when the canvas image is in potrait mode,and max when it is in landscape mode.
...
trigger: "canvas",//change according to the page you needed.
pin: true,
// markers:true,
scroller: `#main`,
//   set start end according to preference
...
gsap.to(`#page13inner2`,{
scrollTrigger:{
scroller:`#main`,
trigger:`#page13inner2`,
scrub:true,
start:`top 60%`,
end:`25% 50%`,
},
...
gsap.to(`#page18 video`,{
scrollTrigger:{
scroller:`#main`,
trigger:`#page18 video`,
scrub:true,
start:`80% top`,
end:`110% top`,
},
...
function files(index) {
var data = `
./Apple vision canvas images/Vision00001.jpg
./Apple vision canvas images/Vision00002.jpg
./Apple vision canvas images/Vision00003.jpg
./Apple vision canvas images/Vision00004.jpg
./Apple vision canvas images/Vision00005.jpg
./Apple vision canvas images/Vision00006.jpg
./Apple vision canvas images/Vision00007.jpg
./Apple vision canvas images/Vision00008.jpg
./Apple vision canvas images/Vision00009.jpg
./Apple vision canvas images/Vision00010.jpg
./Apple vision canvas images/Vision00011.jpg
./Apple vision canvas images/Vision00012.jpg
./Apple vision canvas images/Vision00013.jpg
./Apple vision canvas images/Vision00014.jpg
./Apple vision canvas images/Vision00015.jpg
./Apple vision canvas images/Vision00016.jpg
./Apple vision canvas images/Vision00017.jpg
./Apple vision canvas images/Vision00018.jpg
./Apple vision canvas images/Vision00019.jpg
./Apple vision canvas images/Vision00020.jpg
./Apple vision canvas images/Vision00021.jpg
./Apple vision canvas images/Vision00022.jpg
./Apple vision canvas images/Vision00023.jpg
./Apple vision canvas images/Vision00024.jpg
./Apple vision canvas images/Vision00025.jpg
`;
return data.split("\n")[index];
}
...
//   set start end according to preference
start: `top top`,
end: `100% top`,//this tells that untill how many percentage does the canvas goes
scroller: `#main`,
},
onUpdate: render,
});
...
//   set start end according to preference
start: `top top`,
end: `100% top`,//this unpins the target we have specified 
});
}
canva2();
...
t6.to(`#page25>#lightsoff`,{
opacity:`0`,
})

gsap.to(`#page27>#sensoroff`,{
scrollTrigger:{
scroller:`#main`,
trigger:`#page27>#sensoroff`,
srub:true,
start:`-20% top`,
end:`20% top`,
},
...
}else if(matchMedia(" (min-width:360px) and (max-width:500px)").matches){
    gsap.to(`#page25formobile #imagecontainerpage25formobile>#trackingoffformobile`,{
        scrollTrigger:{
            scroller:`#main`,
            trigger:`#page25formobile #imagecontainerpage25formobile>#trackingoffformobile`,
            scrub:true,
            // markers:true,
            start:`50% 70%`,
            end:`80% 60% `,
